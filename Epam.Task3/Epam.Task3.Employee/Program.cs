    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                workExperience = int.Parse(Console.ReadLine());
            ...
            while (true)
            {
                ...
                Console.WriteLine("Accountant, director or builder");
            ...
            Console.WriteLine("Your work experience: {0}", user.WorkExperience);
            Console.WriteLine("Your position: {0}", user.Position);
        }
    }
}
